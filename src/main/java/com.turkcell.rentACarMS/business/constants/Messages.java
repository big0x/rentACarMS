package com.turkcell.rentACarMS.business.constants;
...
public class Messages {
    ...
    public static final String ADDITIONALSERVICEFOUND = "AdditonalService.Found";
    public static final String ADDITIONALSERVICENOTFOUND = "Cannot find an additional service with this Id";
    public static final String ADDITIONALSERVICEEXISTS = "Such a additonal service exists";
    ...
    public static final String CARDDAMAGEADDED = "CarDamage.Added";
    ...
    public static final String CARDAMAGENOTFOUND = "Cannot find a car damage with this Id";
    public static final String CARDAMAGECARIDNOTFOUND = "The car with this id does not car damage exist";
    ...
    public static final String CARMAINTENANCEFOUND = "CarMaintenance.Found";
    ...
    public static final String CARNOTAVAILABLE = "Car Not Available. Might be on rent or maintenance.";
    ...
    public static final String CITYEXISTS = "Such a city exists";
    ...
    public static final String CORPORATECUSTOMERFOUND = "CorporateCustomer.Found";
    ...
    public static final String INDIVIDUALCUSTOMERFOUND = "IndividualCustomer.Found";
    ...
    public static final String ORDEREDADDITIONALSERVICEFOUND = "OrderedAdditonalService.Found";
    ...
    public static final String PAYMENTINFOFOUND = "PaymentInfo.Found";
    public static final String PAYMENTINFOADDED = "PaymentInfo.Added";
