...
public class CorporateCustomerManager implements CorporateCustomerService {
    ...
    public DataResult<List<ListCorporateCustomerDto>> listAll() {
        ...
        List<ListCorporateCustomerDto> listCorporateCustomerDto = corporateCustomers.stream().map(corporateCustomer -> this.modelMapperService
                .forDto().map(corporateCustomer, ListCorporateCustomerDto.class)).collect(Collectors.toList());
    ...
    public Result delete(DeleteCorporateCustomerRequest deleteCorporateCustomerRequest) {
        if (!checkCorporateCustomerId(deleteCorporateCustomerRequest.getId()).isSuccess()) {
            return new ErrorDataResult<CorporateCustomerDto>(checkCorporateCustomerId(deleteCorporateCustomerRequest.getId()).getMessage());
        }
    ...
    public DataResult<CorporateCustomerDto> getById(int corporateCustomerId) {
        if(!checkCorporateCustomerId(corporateCustomerId).isSuccess()){
            return new ErrorDataResult<CorporateCustomerDto>(checkCorporateCustomerId(corporateCustomerId).getMessage());
        }
    ...
    private Result checkCorporateCustomerId(int corporateCustomerId) {
        if (!this.corporateCustomerDao.existsById(corporateCustomerId)) {
            return new ErrorResult("Corporate Customer not found.");
        }
